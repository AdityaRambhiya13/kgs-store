...
export const bulkReorderProducts = (productIds, adminToken, clearIds = []) =>
    request('POST', '/api/admin/products/bulk-reorder', { product_ids: productIds, clear_ids: clearIds }, null, adminToken)
