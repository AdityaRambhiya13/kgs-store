...
export default function Navbar({ searchQuery, onSearchChange, onCategorySelect }) {
  ...
  return (
    <nav className="navbar">
      <div className="navbar-inner">
        ...
        <div className="nav-top-row">
          ...
          <div className="nav-left">
            ...
            {/* Location selector */}
            <button className="nav-location-btn" style={{ minHeight: '44px' }}>
              ...
              <svg className="nav-location-chevron" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
          </div>
      ...
      {/* Trust strip — COD + payment icons below navbar */}
      <div className="navbar-trust-strip">
        ...
        <span className="navbar-payment-pills">
          <span className="payment-icon-pill upi">UPI</span>
          <span className="payment-icon-pill gpay">GPay</span>
          <span className="payment-icon-pill cash">COD</span>
        </span>
      </div>
    </nav>
  )
